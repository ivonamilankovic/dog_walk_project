...
?>
    ...
    <div class="container">
        ...
        <form action="../include/finishWalk.inc.php" method="post" id="finishWalkForm">
            <div class="d-flex justify-content-center">
                <textarea class="form-control" id="path" name="path" placeholder="Where have you been during the walk?"
                    style="height: 400px; font-size: x-large"></textarea> <br>
            </div>
            <small id="errorPath" style="color: #ff0000"></small>
            <div class="d-flex justify-content-center">
                <input type="hidden" value="<?= isset($_GET['reservation_id']) ? $_GET['reservation_id']:""?>"
                    name="reservation_id">
