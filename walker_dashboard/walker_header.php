...
<div class="p-4 align-self-center">
    <img src="<?php if(!empty($user['picture'])) echo $user['picture']; else echo '../include/profile_images/user-icon.png'; ?>" width="50" height="50" class="img-fluid rounded-circle m-2" alt="Profile picture">
    <div class="btn-group">
