            ...
            <form action="../include/updateStatus.inc.php" method="post">
                <tr>
                    ...
                    <td><select name="status" id="status" class="form-select">
                            <option value="<?php echo $data['status']; ?>" disabled selected>
                        ...
                        <input type="hidden" value="<?php echo $data['email']; ?>" name="customer_email"
                            id="customer_email">
                    </td>
                    <td><button type="submit" class="btn btn-outline-success" name="saveStatus"
                            id="saveStatus">Save</button> </td>
                    <td><a href="./finishWalk.php?reservation_id=<?php echo $data['reservation_id']; ?>"
                            class="btn btn-success">Finish!</a></td>
                </tr>
            </form>
            <?php
        }
