...
?>
    ...
    ?>
        <div class="col-4 mx-auto my-3 border border-2 border-dark rounded p-4 text-center"
            style="background-color: rgba(191,172,170,0.75); border-color: #44310d; width: 400px; height: 400px">
            ...
            <form action="../include/deleteDog.inc.php" method="post">
                ...
                <div class="p-2"><button class="btn btn-secondary btn-sm" name="deleteDog" id="deleteDog"
                        style="background-color: #bfacd5">Delete Dog</button></div>
            </form>
        </div>
        <?php
        }
    ...
    <div class="text-right d-flex justify-content-center">
        <a href="./createDog.php" style="color: #000000; text-decoration: none; font-weight: bold;"><button
                class="btn m-4" style="background-color: #9c7a97; border: 1px solid #000000">Add Dog to your
                profile...</button></a>
    </div>
