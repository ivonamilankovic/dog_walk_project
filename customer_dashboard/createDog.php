                            ...
                            <div class="row gutters">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="dogName" id="dogName"
                                            placeholder="Enter Dogs name" value="">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" name="dogGender"
                                            id="dogGender">
                                            <option value="choose" name="dogGender" disabled selected>--choose--
                                            </option>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="dogAge" id="dogAge"
                                            placeholder="Dogs age" min="0" max="30" maxlength="2" value="">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                    ...
                                    ?>
                                        ...
                                        foreach ($results as $output) {?>
                                            <option value="<?php echo $output["id"];?>" name="breed_id">
                                                <?php echo $output["breed_name"];?></option>
                                            <?php
                                        }
                                        ?>
                                        </select>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="notes" name="notes"
                                            placeholder="About your Dog..." style="height: 200px"></textarea>
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="row gutters">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="text-right d-flex justify-content-center">
                                            <button type="submit" name="createDog" id="createBtn" class="btn m-4"
                                                style="background-color: #9c7a97; border: 1px solid #000000; font-weight: bold; color:#000000">Create
                                                a Dog</button>
                                        </div>
                                    </div>
                                </div>
