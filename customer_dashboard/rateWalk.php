        ...
        <div class="d-flex justify-content-center">
            <form action="../include/rateWalk.inc.php" method="post">
                <table class="p-4">
                    ...
                    <tr>
                        <td class="px-4"><input id="r1" type="radio" name="rate" value="1"><label for="r1"><img
                                    src="../images/star.png" alt="star"></label></td>
                        <td class="px-4"><input id="r2" type="radio" name="rate" value="2"><label for="r2"><img
                                    src="../images/star.png" alt="star"></label></td>
                        <td class="px-4"><input id="r3" type="radio" name="rate" value="3" checked><label for="r3"><img
                                    src="../images/star.png" alt="star"></label></td>
                        <td class="px-4"><input id="r4" type="radio" name="rate" value="4"><label for="r4"><img
                                    src="../images/star.png" alt="star"></label></td>
                        <td class="px-4"><input id="r5" type="radio" name="rate" value="5"><label for="r5"><img
                                    src="../images/star.png" alt="star"></label></td>
                    </tr>
                </table>
                <div class="d-flex justify-content-center p-4">
