...
<div class="header h-75">
    <div class="container d-flex">
        ...
        <div class="p-4"><button type="button" class="btn btn-light"><a href="./login.php" class="link">log-in</a></button></div>
        <div class="p-4"><button type="button" class="btn btn-light"><a href="./signup.php" class="link">sign-up</a></button></div>
    </div>
...
<div class="footer">
    <div class="container  d-flex justify-content-between p-4">
        ...
        <div>
            <div><a href="#"><img src="images/facebook.png" alt="facebookLogo" class="social"></a> </div>
            <div><a href="#"><img src="images/linkedin.png" alt="linkedinLogo" class="social"></a> </div>
            <div><a href="#"><img src="images/instagram.png" alt="intagramLogo" class="social"></a> </div>
        </div>
    </div>
</div>
