        ...
        <div class="row mx-auto">
            <div class="col-sm-8 col-lg-6 text-center mt-5 m-auto">
                <div class="form-floating mx-auto">
                    <input class="form-control" id="emailP" name="email" type="email" placeholder="Email"
                        value="<?php if (!empty($userData)) echo $userData['email'];?>">
                    <label for="emailP">Email</label>
                </div>
                <br>
                <div class="form-floating mx-auto">
                    <input class="form-control" id="newPassword1" name="newPass1" type="password"
                        placeholder="New Password">
                    <label for="newPassword1">New Password</label>
                </div>
                <br>
                <div class="form-floating mx-auto">
                    <input class="form-control" id="newPassword2" name="newPass2" type="password"
                ...
                <br>
                <button type="submit" name="submit" id="changePasswordBtn" class="btn btn-primary m-auto mt-4"
                    style="background-color: #9c7a97; border: 1px solid #000000; font-weight: bold; color:#000000">Change</button>
            </div>
        </div>
    </div>
