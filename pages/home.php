...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Lobster&family=Poppins:wght@100;300;600&display=swap"
        rel="stylesheet">
</head>
...
<body>
    ...
    <div class="loader d-flex align-items-center " id="loader"><img class="text-center" src="../images/loading-img.gif"
            alt="loading..."></div>
    <!--dog_walk picture-->
    <div class="picture-text">
        ...
        <div class="centered-bottom btn_see_walkers"><a href="./allWalkers.php"><button id="btnonimg" type="button"
                    class="btn btn-outline-dark ">See walkers</button></a></div>
    </div>
    ...
    <div class="container mt-4 p-4" id="howToUse">
        <!--how to use site-->
        <div class="container-fluid border rounded-pill p-4 mt-4"
            style="background: rgb(255,239,159); background: radial-gradient(circle, rgba(255,239,159,0.8) 0%, rgba(201,196,196,1) 100%);">
            <div class="d-flex justify-content-between align-items-center site-journey">
                <button type="button" class="btn btn-outline-dark rounded-pill" data-bs-toggle="modal"
                    data-bs-target="#modal_signup" style="width: 10rem; height:4rem; background-color: #866464"><b>Sign
                        Up!</b></button>
                <div><img src="../images/arrow.png" alt="arrow" style="width: 90px; height: 80px"></div>
                <button id="findWalkers1" type="button" class="findWalkers btn btn-outline-dark rounded-pill"
                    style="width: 10rem; height:4rem; background-color: #866464"><b>Find your dog walker!</b></button>
                <div><img src="../images/arrow.png" alt="arrow" style="width: 90px; height: 80px"></div>
                <button id="findWalkers2" type="button" class="findWalkers btn btn-outline-dark rounded-pill"
                    style="width: 10rem; height:4rem; background-color: #866464"><b>Enjoy your freedom!</b></button>
            </div>
        </div>
    </div>
            ...
            <div class="card mb-3" style="max-width: 540px;">
                <div class="row g-0">
                    <div class="col-md-4 align-self-center p-2">
                        <img src="<?php if (!empty($walker['picture'])) echo $walker['picture'];
                                        else echo '../include/profile_images/user-icon.png'; ?>"
                            class="img-fluid rounded-circle picture_card" alt="profile picture">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo $walker['first_name'] . " " . $walker['last_name']; ?>
                            </h5>
                            <p class="card-text"><?php echo $walker['biography']; ?></p>
                            <span class=" d-flex justify-content-between"><small class="text-muted"><a
                                        href="./oneWalker.php?walker=<?php echo $walker['walker_id']; ?>">View</a></small><small>Average
                                    rate: <?php echo round($walker['avg_rate'], 2); ?></small></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p class="card-text"><?php echo $walker['biography']; ?></p>
                            <span class=" d-flex justify-content-between"><small class="text-muted"><a
                                        href="./oneWalker.php?walker=<?php echo $walker['walker_id']; ?>">View</a></small><small>Number
                                    of walks: <?php echo $walker['num_walks']; ?></small></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid border rounded p-4 about_home" style="background-color: #C4C4C4; text-align: center;">
        <div class="d-inline"><img src="../images/paw.svg" class="social">
            <h2>Here when you need us</h2>
        </div>
        <p class="p-4 about-text">Whether you're looking for daily walks, planning a trip, stuck at work, or just want
            your best friend to have some company — we offer any day, anytime care.</p>
        <div class="d-inline"><img src="../images/paw.svg" class="social">
            <h2>Safety is serious business</h2>
        </div>
        <p class="p-4 about-text">Your dog's safety is our top priority. Every Pet Caregiver passes an enhanced
            background check, our services are insured, and support is standing by around the clock.</p>
        <div class="d-inline"><img src="../images/paw.svg" class="social">
            <h2>We've been around the block</h2>
        </div>
        <p class="p-4 about-text">Paw Walks has a trusted record of experience with over 10M pet care services across
            4,600 cities and counting. More than 150,000 Pet Caregivers nationwide are dog people, and it shows.</p>
    </div>
