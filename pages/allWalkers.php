                ...
                <div class="row g-0">
                    <div class="col-md-4 align-self-center p-2">
                        <img src="<?php if(!empty($walker['picture'])) echo $walker['picture']; else echo '../include/profile_images/user-icon.png'; ?>"
                            width="130" height="130" class="img-fluid rounded-circle picture_card"
                            alt="profile picture">
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <span class="d-flex justify-content-between align-middle">
                                <small class="text-muted">
                                    <a id="viewWalker"
                                        href="./oneWalker.php?walker=<?php echo $walker['walker_id'];?>">View</a>
                                </small>
    ...
    <div class="container setac_pojedinacno">
        <div class="row border rounded karta mx-auto pt-3">
            <div class="card mb-3 mx-auto">
                <div class="row g-0">
                    <div class="col-md-4 align-self-center p-2">
                        <img src="<?php if(!empty($new['picture'])) echo $new['picture']; else echo '../include/profile_images/user-icon.png'; ?>"
                            width="130" height="130" class="img-fluid rounded-circle picture_card"
                            alt="profile picture">
                    </div>
                    <div class="col-md-8 my-3">
                        <div class="card-body">
                            ...
                            <p class="card-text" style="font-style: italic">
                                <?php if(!empty($new['biography'])) echo $new['biography']; else echo '<span style="color: gray;">No biography</span>'; ?>
                            </p>
                            <span class="d-flex justify-content-between align-middle">
                                <small class="text-muted">
